...
class WCFMvm_Frontend {
  ...
  function wcfmvm_vendor_membership_user_setting_block( $user_id ) {
  	$membership_block_id = apply_filters( 'wcfm_membership_block_id', 'sm_profile_manage_form_membership_head' );
  	?>
  	<a href="<?php echo get_wcfm_profile_url(); ?>#<?php echo $membership_block_id; ?>" class="page_collapsible page_collapsible_dummy" id="<?php echo $membership_block_id; ?>"><label class="fa fa-user-plus"></label><?php _e( 'Membership', 'wc-multivendor-membership' ); ?><span></span></a>
  ...
  function wcfmvm_vendor_membership_user_setting_header( $user_id ) {
  	...
  	echo '<a id="wcfm_membership_settings" class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_profile_url().'#' . $membership_block_id . '" data-tip="' . __( 'Membership', 'wc-multivendor-membership' ) . '"><span class="fa fa-user-plus"></span><span class="text">' . __( 'Membership', 'wc-multivendor-membership' ) . '</span></a>';
  }
  ...
  function wcfmvm_vendor_membership_user_profile() {
		...
		?>
		<div class="page_collapsible profile_manage_membership" id="<?php echo $membership_block_id; ?>"><label class="fa fa-user-plus"></label><?php _e( 'Membership', 'wc-multivendor-membership' ); ?><span></span></div>
		<div class="wcfm-container">
