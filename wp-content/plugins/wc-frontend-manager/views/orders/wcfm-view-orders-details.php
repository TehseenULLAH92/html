			...
			<div id="orders_details_items_expander" class="wcfm-content">
				...
				<div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
								...
								<div class="wc-used-coupons">
									<ul class="wc_coupon_list"><?php
										...
										foreach ( $coupons as $item_id => $item ) {
											...
											if( !current_user_can( 'edit_shop_coupons' ) || !apply_filters( 'wcfm_is_allow_manage_coupons', true ) ) { $link = '#'; }
					...
					<table class="wc-order-totals">
						<?php if( apply_filters( 'wcfm_order_details_coupon_line_item', true ) ) { ?>
							<tr>
								<th class="label"><span class="fa fa-question-circle-o no_mob img_tip" data-tip="<?php _e( 'This is the total discount. Discounts are defined per line item.', 'wc-frontend-manager' ) ; ?>"></span> <?php _e( 'Discount', 'wc-frontend-manager' ); ?>:</th>
								<td width="1%"></td>
								<td class="total">
						...
						<?php if( apply_filters( 'wcfm_order_details_shipping_line_item', true ) && apply_filters( 'wcfm_order_details_shipping_total', true ) && $order->needs_shipping_address() ) { ?>
							<tr>
								<th class="label"><span class="fa fa-question-circle-o no_mob img_tip" data-tip="<?php _e( 'This is the shipping and handling total costs for the order.', 'wc-frontend-manager' ) ; ?>"></span> <?php _e( 'Shipping', 'wc-frontend-manager' ); ?>:</th>
								<td width="1%"></td>
								<td class="total"><?php
