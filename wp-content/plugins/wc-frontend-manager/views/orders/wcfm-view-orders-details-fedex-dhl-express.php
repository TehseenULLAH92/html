...
global $WCFM, $woodhlwrapperadmin, $woofedexwrapperadmin, $wooeasypostwrapperadmin;
...
if( WCFM_Dependencies::wcfm_wc_easypost_shipping_active_check() ) {
	if ( ! class_exists( 'WCFM_Shipping_Easypost_Admin' ) ) {
		include_once $WCFM->plugin_path . 'includes/libs/easypost/class-wcfm-shipping-easypost-admin.php';
	
		$wooeasypostwrapperadmin = new WCFM_Shipping_Easypost_Admin();
		
		add_action( 'end_wcfm_orders_details', 'wcfm_orders_details_easypost_shipping', 9 );
	}
}

function wcfm_orders_details_easypost_shipping() { 
	global $wp, $WCFM, $wooeasypostwrapperadmin;
	...
	<div class="wcfm-clearfix"></div><br />
	<!-- collapsible -->
	<div class="page_collapsible wc_easypost_shipping" id="wcfm_wc_easypost_shipping_options"><?php _e('Easypost.com Shipment Label', 'wf-easypost'); ?><span></span></div>
	<div class="wcfm-container">
		<div id="wc_easypost_shipping_expander" class="wcfm-content">
			<?php
			if( $wooeasypostwrapperadmin )
				$wooeasypostwrapperadmin->wf_easypost_metabox_content( $order_id );
			?>
			<div class="wcfm-clearfix"></div>
		</div>
	</div>
