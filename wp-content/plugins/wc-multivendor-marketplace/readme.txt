...
👉 [Vednor Registration](https://wclovers.com/knowledgebase/wcfm-marketplace-vendor-registration/)

= Short Codes =

👉 wcfm_stores     - List all stores (Store location in map with location filter)
...
* Tweak    - For Vendor products only vednor shipping options available at checkout, if no vendor shipping setup then admin option will visible  
