  ...
  function wcfmmp_product_multivendor_button() {
  	...
  	if( $this->is_already_selling( $product_id ) ) return;
		...
		<div class="wcfm_ele_wrapper wcfm_product_multivendor_button_wrapper">
			...
			<a href="#" class="wcfm_product_multivendor" data-product_id="<?php echo $product_id; ?>"><span class="fa fa-cube"></span>&nbsp;&nbsp;<span class="product_multivendor_label"><?php _e( $wcfm_product_multivendor_button_label, 'wc-multivendor-marketplace' ); ?></span></a>
			<div class="wcfm-clearfix"></div>
		</div>
		<?php
  }
