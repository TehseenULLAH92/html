...
class WCFMmp_Shortcode {
	...
	public function wcfmmp_stores_shortcode( $atts ) {
		global $WCFM, $WCFMmp, $wp, $WCFM_Query, $excludes;
		$WCFM->nocache();
	...
	public function wcfmmp_store_hours_shortcode( $attr ) {
		...
		$content .= '<span class="wcfmmp-store-hours widget-title"><span class="fa fa-clock"></span>&nbsp;' . apply_filters( 'wcfm_store_hours_label', __( 'Store Hours', 'wc-multivendor-marketplace' ) ) . '</span><div class="wcfm_clearfix"></div>';
