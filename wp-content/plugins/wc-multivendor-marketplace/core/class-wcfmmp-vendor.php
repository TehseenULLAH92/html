...
class WCFMmp_Vendor {
	...
	function wcfmmp_vendor_manage_shipping_setting( $vendor_id ) {
		...
		<!-- collapsible -->
		<div class="page_collapsible vendor_manage_store_shipping_setting" id="wcfm_vendor_manage_form_store_shipping_settings_head"><label class="fa fa-truck"></label><?php _e( 'Store Shipping', 'wc-multivendor-marketplace' ); ?><span></span></div>
		<div class="wcfm-container">
	...
	function wcfmmp_vendor_manage_orders( $vendor_admin_id, $vendor_id ) {
		...
		?>
		<!-- collapsible - Orders -->
		<div class="page_collapsible vendor_manage_orders" id="wcfm_vendors_orders_head"><label class="fa fa-cart-plus"></label>&nbsp;<?php _e('Store Orders', 'wc-multivendor-marketplace'); ?></div>
	...
	function wcfmmp_vendor_product_stock_notification( $recipient, $product ) {
		...
		if( apply_filters( 'wcfmmp_is_allow_vendor_stock_notification', true ) ) {
			$vednor_id = $WCFM->wcfm_vendor_support->wcfm_get_vendor_id_from_product( $product->get_id() );
			if( $vednor_id ) {
	...
	function wcfmmp_search_vendor_list( $all = false, $offset = '', $number = '', $search = '', $category = '', $search_data = array(), $has_product = '', $allow_vendors_list = array() ) {
		return $this->wcfmmp_get_vendor_list( $all, $offset, $number, $search, $allow_vendors_list, 'ASC', 'login', $search_data, $category, $has_product );
	}
