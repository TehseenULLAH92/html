...
<style>
.order-again, div.wc-booking-summary-actions { display: none; }
...
<div style="margin-bottom: 40px;">
	...
	<table class="woocommerce-table wcfm-order-details-table woocommerce-table--order-details shop_table order_details" style="width: 100%; border: 1px solid #e5e5e5; border-top: 4px solid #e5e5e5; text-align:right;" border="0" border="0" cellspacing="0" cellpadding="6">
		<tbody>
